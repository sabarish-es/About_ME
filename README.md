...
> ⚙️ **Profile cards & contribution snake are generated automatically by GitHub Actions.**
> After uploading this repository, open **Actions → Update GitHub Profile Cards → Run workflow** once.
...
> These cards are generated by GitHub Actions and stored directly in this repository, so they don't depend on third-party image servers.
